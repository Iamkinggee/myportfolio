...
//     <ProjectCard title='Oasisportal' techtools='Next.js 16, Typescript, Tailwind CSS, supabase' discription='Oasis portal is a fullstack group management SAAS platform' visitsitebutton='Visit Site' viewcodebutton='Demo'  image={<img  loading='lazy' src={Oasisportal} alt="/"  className='  object-contain h-full p-3  m-auto w-full md:h-[350px] md:w-[500px] bg-transparent'  />} visitsitelink={'https://oasisportal.vercel.app/'} viewcodelink={'https://drive.google.com/file/d/1jMqNKjAUo_EncfwwmFyteIJrqE0Py93K/view?usp=sharing'} />


//     <ProjectCard title='osejie studio' techtools='Next.js 16, Typescript, python, Tailwind CSS, supabase, claude AI' discription='Osejie studio is an ongoing vibe coded Ai agent project for creators. By a single title prompt it generates a story script, voice over, images for each scene, adds background music, compile the entire clip ready for upload. ' visitsitebutton='Visit Site' viewcodebutton='Demo'  image={<img  loading='lazy' src={aiagent} alt="/"  className='  object-contain h-full p-3  m-auto w-full md:h-[350px] md:w-[500px] bg-transparent'  />} visitsitelink={'#'} viewcodelink={'https://drive.google.com/file/d/1Mt1CfVyIHVUdLslwWEG4rz42m4UpICTW/view?usp=drive_link'} />
...
// <ProjectCard title='SAAS Landing page' techtools='Nextjs 16,typescript, Tailwindwind.' discription='SAAS landing page is an ongoing development project' visitsitebutton='Visit Site' viewcodebutton='View Code'  image={<img  loading='lazy' src={SAAS} alt="/"  className='  object-contain h-full p-3  m-auto w-full md:h-[350px] md:w-[500px] bg-transparent'  />}    visitsitelink={null} viewcodelink={null}  
  ...
  return (
    <div className='w-full font-[syne]' id='works'>
      <div className='max-w-[1000px] font-mono text-black m-auto'>
        ...
        <h1 className='font-bold text-neutral-500 text-[30px] sm:text-center md:text-[50px] font-[syne] front-extrabold text-center md:text-center pt-20' id='text-title'>
          Projects
        </h1>
        <p className='pb-10 text-center font-[LexendZetta] md:text-[20px] text-[13px] text-white'>
          These are some of my <br />latest Projects.
        </p>
        ...
        <div>
          ...
          <ProjectCard
            title='CoinDucko'
            techtools='Coingecko API, Javascript, Tailwind CSS, React.js'
            discription='CoinDucko is a digital platform - built with the CoinGecko API; provides real-time data on various cryptocurrencies, including their current price, market cap and trading volume. Users can easily search for specific coins and view detailed information about them. The sleek and intuitive design makes it easy for users to stay updated on the latest crypto trends and make informed decisions.'
            visitsitebutton='Visit Site'
            viewcodebutton='View Code'
            image={<img loading='lazy' src={CoinDuckoImage} alt="CoinDucko" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink='https://coin-ducko.vercel.app/'
            viewcodelink='https://github.com/Iamkinggee/Coinducko.git'
          />

          <ProjectCard
            title='Audiophile'
            techtools='Next.js 16, Typescript, Tailwind CSS, Convex'
            discription='Audiophile is a premium e-commerce store specializing in high-end audio gear—including speakers, headphones, earphones, and accessories. The store features a modern UI, product categories, detailed product pages, cart and checkout flow, and a responsive layout designed for a smooth shopping experience across all devices.'
            visitsitebutton='Visit Site'
            viewcodebutton='View Code'
          ...
          <ProjectCard
            title='Oasisportal'
            techtools='Next.js 16, Typescript, Tailwind CSS, Supabase'
            discription='Oasis portal is a fullstack group management SAAS platform'
            visitsitebutton='Visit Site'
            viewcodebutton='Demo'
            image={<img loading='lazy' src={Oasisportal} alt="Oasisportal" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink='https://oasisportal.vercel.app/'
            viewcodelink='https://drive.google.com/file/d/1jMqNKjAUo_EncfwwmFyteIJrqE0Py93K/view?usp=sharing'
          />

          <ProjectCard
            title='Osejie Studio'
            techtools='Next.js 16, Typescript, Python, Tailwind CSS, Supabase, Claude AI'
            discription='Osejie studio is an ongoing vibe coded AI agent project for creators. By a single title prompt it generates a story script, voice over, images for each scene, adds background music, compile the entire clip ready for upload.'
            visitsitebutton='Visit Site'
            viewcodebutton='Demo'
            image={<img loading='lazy' src={aiagent} alt="Osejie Studio" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink={null}
            viewcodelink='https://drive.google.com/file/d/1Mt1CfVyIHVUdLslwWEG4rz42m4UpICTW/view?usp=drive_link'
          />

          <ProjectCard
            title='Born-great Daycare'
            techtools='Next.js 16, Typescript, Tailwind CSS,'
            discription='This is a daycare services website'
            visitsitebutton='Visit Site'
            viewcodebutton='View Code'
            image={<img loading='lazy' src={borngreat} alt="Born-great Daycare" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink='https://borngreatdaycare.vercel.app/'
            viewcodelink='https://github.com/Iamkinggee/born-great-Daycare.git'
          />
          <ProjectCard
            title='Futures Mentor'
            techtools='Next.js 16, Typescript, Tailwind CSS, Supabase, Claude AI, Groq AI'
            discription='AI-powered futures trading intelligence that reads Smart Money Concepts, calculates your risk and coaches you to consistent profitability.'
            visitsitebutton='Visit Site'
            viewcodebutton='View Code'
            image={<img loading='lazy' src={FT} alt="Futures-mentor" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink='https://futures-mentor.vercel.app/'
            viewcodelink='https://github.com/Iamkinggee/futuresmentor.git'
          />

          <ProjectCard
            title='Gee Movies'
            techtools='TMDB API, Javascript, React.js, Firebase, Tailwind CSS'
            discription='Gee Movies is a Fullstack free Movie platform, built with the TMDB API, ReactJS for the frontend and Firebase for the backend. Users can signup create account, select and save movies to their secured accounts.'
            visitsitebutton='Visit Site'
            viewcodebutton='View Code'
            image={<img loading='lazy' src={Movie} alt="Gee Movies" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink='https://geemovies.vercel.app/'
            viewcodelink='https://github.com/Iamkinggee/geemovies.git'
          />

          <ProjectCard
            title='KingsTickets'
            techtools='Vue, Tailwind CSS'
            discription='The Ticket Generator is a web application that creates personalized digital event tickets. Built with a modern UI and smooth form handling, the app makes ticket creation fast, intuitive, and visually appealing.'
            visitsitebutton='Visit Site'
            viewcodebutton='View Code'
          ...
          <ProjectCard
            ...
            discription='This is a bill payment mobile app platform for airtime, data, electricity bill, tickets e.t.c (uncompleted)'
            visitsitebutton='Demo'
            viewcodebutton='View Code'
            image={<img loading='lazy' src={paypoint} alt="Paypoint" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink='https://drive.google.com/file/d/1KpActRBHO3dqBbcNfk-lECi0TNObTa31/view?usp=drivesdk'
            viewcodelink={null}
          />

          <ProjectCard
            title='Natsent iPhone Store'
            techtools='Javascript, Tailwind CSS, React.js'
            discription='Natsent iPhone Store is a one stop shop for all iPhone devices.'
            visitsitebutton='Visit Site'
            viewcodebutton='View Code'
            image={<img loading='lazy' src={natsentpix} alt="Natsent iPhone Store" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink='https://natsent.vercel.app/'
            viewcodelink={null}
          />

          <ProjectCard
            title='Oops Landing Page'
            techtools='Javascript, Tailwind CSS, React.js'
            discription='OOPS project is a simple landing page design'
            visitsitebutton='Visit Site'
            viewcodebutton='View Code'
            image={<img loading='lazy' src={oops} alt="Oops Landing Page" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink='https://oops-kappa.vercel.app/'
            viewcodelink={null}
          />
          ...
          <ProjectCard
            ...
            techtools='React Native, Javascript, Nativewind'
            MobileApp="Mobile App"
            discription='This is the Guaranty Trust Bank (GTB) Mobile App UI Clone'
            visitsitebutton='Demo'
            viewcodebutton='View Code'
            image={<img loading='lazy' src={GTphoto} alt="GT Bank" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink='https://drive.google.com/file/d/1uUj8zG22qIgRV9SskyGt08pN7tfve0iz/view?usp=drive_link'
          ...
          <ProjectCard
            ...
            visitsitebutton='Visit Site'
            viewcodebutton='View Code'
            image={<img loading='lazy' src={amastoreImage} alt="Amastore" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink='https://amastore-mauve.vercel.app/'
            viewcodelink='https://github.com/Iamkinggee/Amastore.git'
          />

          <ProjectCard
            title='SAAS Landing Page'
            techtools='Next.js 16, Typescript, Tailwind CSS'
            discription='SAAS landing page is an ongoing development project'
            visitsitebutton='Visit Site'
            viewcodebutton='View Code'
            image={<img loading='lazy' src={SAAS} alt="SAAS Landing Page" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink={null}
            viewcodelink={null}
          />
          ...
          <ProjectCard
            title='Dataport'
            techtools='React.js, Javascript, Tailwind CSS'
            discription='DataPort is a simple landing page for DataPort Company Inc.'
            visitsitebutton='Visit Site'
            viewcodebutton='View Code'
            image={<img loading='lazy' src={dataport} alt="Dataport" className='object-contain h-full p-3 m-auto w-full md:h-[350px] md:w-[500px] bg-transparent' />}
            visitsitelink='https://dataport.vercel.app/'
            viewcodelink='https://vercel.com/godsent-oko-oses-projects/dataport/CFnbWR67a6uFNgcM9JodNMoUxYYe/source'
          />
