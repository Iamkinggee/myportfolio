    ...
    <div id='about' className=' w-full   px-4 m-auto pt-5 md:pt-2'>
        <div className='grid md:grid-cols-2 max-w-[1000px]  items-center justify-center  mx-auto '>
         ...
         <h1 className=' text-[15px] md:text-xl   text-center md:text-start justify-center items-center  sm:text-center text-white font-[syne]  font-semibold ' id='text-black'>Software<span className='text-blue-600 font-[syne]  font-semibold'  id='text-blue'>Developer</span></h1>
            ...
            <button className='  p-3 font-[syne]   w-[300px] bg-blue-600 text-white md:text-[20px] text-[11px] rounded hover:scale-105 duration-300 shadow-lg'>Let's Talk</button>            
            </ScrollLink>      
