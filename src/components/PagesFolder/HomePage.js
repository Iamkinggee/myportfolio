    ...
    <div className=' w-full  mt-10 md:h-screen  h-[700px] text-black font-[poppins]' id="home">
        <div className=' grid md:grid-cols-2  max-w-[1000px] items-center justify-center  h-full m-auto '>
         ...
         <Fade cascade damping={0.5} fraction={0.5} duration={200}> 
            <h1 className=' text-[25px] font-semibold font-[syne] text-center md:text-start tracking-widest justify-center items-center text-white ' id='text-black'>Howdy, i'm a</h1>
            <h1 className='text-[30px] md:text-[60px]  font-extrabold opacity-15 leading-none text-center py-3 md:text-start text-white font-[syne]  ' id='text-black'>Software <br />Developer.</h1>
